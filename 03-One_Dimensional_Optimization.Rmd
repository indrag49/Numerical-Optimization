...
* `fun, jac, hess`: Provides the objective function, Jacobian and the Hessian matrix at the solution $x^*$ as \texttt{ndarray} objects,
...
* `maxcv`: This is a \texttt{float} object and represents the maximum constraint evaluation.