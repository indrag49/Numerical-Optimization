...
We see we have set our initial interval as asked, by setting the parameter \texttt{bracket=[-1., 2.]}. The root is $\sim 1.77$. The optimization data has been collected and is shown below:
